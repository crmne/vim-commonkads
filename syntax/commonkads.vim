...
" Section: keywords
syn keyword kadsKeywords attributes specification concept use end type ordinal nominal description axioms antecedent consequent uses expressions from roles input output static inference task goal roles realizes decomposition intermediate while repeat until empty and or real add delete dynamic
